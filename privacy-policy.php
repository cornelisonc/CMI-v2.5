...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-lg-9">
			...
			<p>This privacy policy sets out how color-my-i uses and protects any information that you give us when you use this website.</p>
			<p>color-my-i is committed to ensuring that your privacy is protected. Should we ask you to provide certain information by which you can be identified when using this website, then you can be assured that it will only be used in accordance with this privacy statement.</p>
			...
			<p>If you feel any of your personal information is being misused in any way, please feel free to contact us via email at <a href="#">info@colormyi.com</a> or through the contact form on our website.</p> 						
